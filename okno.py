...
login_text = Listbox(text_frame, height=1, width=30,  borderwidth=2, font=main_font)
...
password_text = Listbox(text_frame, height=1, width=30, borderwidth=2, font=main_font)
...
note_text = Listbox(text_frame,height=7, width=30, borderwidth=2, font=main_font)
