...
search_label = Label(input_frame, text="Hledej: ", width=20, bg=main_color, borderwidth=0, font=main_font)
...
choice_list.grid(row=2, column=0)
...
# button frame
edit_button = Button(buttons_frame, text="Editovat", width=10, font=main_font)
edit_button.pack()
